...
setpath "product" "licenseUrl" "https://github.com/VSCodium/manekicode/blob/master/LICENSE"
setpath_json "product" "linkProtectionTrustedDomains" '["https://open-vsx.org"]'
setpath "product" "releaseNotesUrl" "https://go.microsoft.com/fwlink/?LinkID=533483#vscode"
setpath "product" "reportIssueUrl" "https://github.com/VSCodium/manekicode/issues/new"
...
if [[ "${DISABLE_UPDATE}" != "yes" ]]; then
  ...
  if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
    setpath "product" "downloadUrl" "https://github.com/VSCodium/manekicode-insiders/releases"
  else
    setpath "product" "downloadUrl" "https://github.com/VSCodium/manekicode/releases"
  fi
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "ManekiCode - Insiders"
  setpath "product" "nameLong" "ManekiCode - Insiders"
  setpath "product" "applicationName" "manekicode-insiders"
  setpath "product" "dataextensionName" ".manekicode-insiders"
  setpath "product" "linuxIconName" "manekicode-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "manekicode-insiders"
  setpath "product" "serverApplicationName" "manekicode-server-insiders"
  setpath "product" "serverDataFolderName" ".manekicode-server-insiders"
  setpath "product" "serverDataextensionName" ".manekicode-server-insiders"
  setpath "product" "darwinBundleIdentifier" "com.manekicode.ManekiCodeInsiders"
  setpath "product" "win32AppUserModelId" "ManekiCode.ManekiCodeInsiders"
  setpath "product" "win32DirName" "ManekiCode Insiders"
  setpath "product" "win32MutexName" "manekicodeinsiders"
  setpath "product" "win32NameVersion" "ManekiCode Insiders"
  setpath "product" "win32RegValueName" "ManekiCodeInsiders"
  setpath "product" "win32ShellNameShort" "ManekiCode Insiders"
  ...
  setpath "product" "tunnelApplicationName" "manekicode-insiders-tunnel"
  setpath "product" "win32TunnelServiceMutex" "manekicodeinsiders-tunnelservice"
  setpath "product" "win32TunnelMutex" "manekicodeinsiders-tunnel"
  ...
  setpath "product" "nameShort" "ManekiCode"
  setpath "product" "nameLong" "ManekiCode"
  setpath "product" "applicationName" "manekicode"
  setpath "product" "linuxIconName" "manekicode"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "manekicode"
  setpath "product" "serverApplicationName" "manekicode-server"
  setpath "product" "serverDataFolderName" ".manekicode-server"
  setpath "product" "serverDataextensionName" ".manekicode-server"
  setpath "product" "darwinBundleIdentifier" "com.manekicode"
  setpath "product" "win32AppUserModelId" "ManekiCode.ManekiCode"
  setpath "product" "win32DirName" "ManekiCode"
  setpath "product" "win32MutexName" "manekicode"
  setpath "product" "win32NameVersion" "ManekiCode"
  setpath "product" "win32RegValueName" "ManekiCode"
  setpath "product" "win32ShellNameShort" "ManekiCode"
  ...
  setpath "product" "tunnelApplicationName" "manekicode-tunnel"
  setpath "product" "win32TunnelServiceMutex" "manekicode-tunnelservice"
  setpath "product" "win32TunnelMutex" "manekicode-tunnel"
